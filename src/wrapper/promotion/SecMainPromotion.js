...
const SecMainPromotion = () => {
 ...
 return (<>
             <Stack spacing={1} sx={{m:2}} direction="row">
                <Typography variant='h6'>รายละเอียดโปรโมชั่น</Typography>
                <Link to={"/promotion/add"} style={{textDecoration: "none"}}><Button variant="contained" color="info"><AddIcon /> เพิ่มข้อมูล</Button></Link>
            </Stack>
...
export default SecMainPromotion