...
const SecMainPayment = () => {
  ...
  return (<>
            <Stack spacing={1} sx={{m:1}} direction="row">
                <Typography variant='h6'>ตั้งค่าการชำระเงิน</Typography>
                <Link to={"/payment/add"} style={{textDecoration: "none"}}><Button variant="contained" color="info"><AddIcon /> เพิ่มข้อมูล</Button></Link>
            </Stack>
