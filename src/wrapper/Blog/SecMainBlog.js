...
const SecMainBlog = () => {
  ...
  return (<>
          <Stack spacing={1} sx={{m:1.5}} direction="row">
                <Typography variant='h6'>รายละเอียดข่าว</Typography>
                <Link to={"/blog/add"} style={{textDecoration: "none"}}><Button variant="contained" color="info"><AddIcon /> เพิ่มข่าว</Button></Link>
          </Stack>
