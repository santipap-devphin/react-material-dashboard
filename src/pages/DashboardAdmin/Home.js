...
import CardDB from '../../component/CardDashboard/CardDB';
                          ...
                          <Stack spacing={2} sx={{ml:matches ? 0 : 10 , mr:matches ? 0 : 5}}>
                           ...
                           <Grid container spacing={1} sx={{ml:matches ? 0 : 10}}>
                              <Grid item xs={12} sm={12} md={12} lg={3}>
                                  <CardDB icons={<PersonAddAlt1Icon sx={{fontSize:110}}/> } textmsg={"สมาชิกใหม่"} count={"10"}  />
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={3} >
                                  <CardDB icons={<MonetizationOnIcon sx={{fontSize:100}}/> } textmsg={"ยอดขาย"} count={"10"}  />
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={3} >
                                  <CardDB icons={<BookmarkBorderIcon sx={{fontSize:100}}/> } textmsg={"ออเดอร์"} count={"500"}  />
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={3} >
                                  <CardDB icons={<CircleNotificationsIcon sx={{fontSize:100}}/> } textmsg={"แจ้งเตือน"} count={"10"}  />
                              </Grid>
                              {/** section graph */}
