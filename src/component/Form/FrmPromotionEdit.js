...
const handleToggle = (value) => () => {
        ...
        if(chipData.length > 0){
            ...
            try {
                ...
                if(response.data.code === 1){
                    ...
                    setTimeout(function() {navicate("/promotion")}, 3500);
  ...
  return (<> 
             ...
             <Grid container sx={{m:1}}>
                <Grid item xs={4}>
                    <Link to={"/promotion"} style={{textDecoration: "none"}}><Button variant="contained" color="primary"><ArrowBackIcon/> กลับ</Button></Link>
                </Grid>
            </Grid>
            {
                alertStatus ? 
