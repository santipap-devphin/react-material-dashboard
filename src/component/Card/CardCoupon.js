...
import {Typography, Box  , IconButton , Grid , FormGroup , FormControlLabel , Switch}  from '@mui/material';
  ...
  return (<Box
            ...
            <Grid container>
                    <Grid item xs={2}>
                        ...
                        <Link to={`/coupon/edit/${data.id}`} style={{textDecoration: "none"}}>
                    ...
                    <Grid item xs={10}>
                        ...
                        <FormGroup>
                            <FormControlLabel control={<Switch checked={data.status}  />} />
                        </FormGroup>
                    </Grid>
             </Grid>
